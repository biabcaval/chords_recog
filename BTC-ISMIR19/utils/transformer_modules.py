...
# ============================================================================
# Bi-directional Self-Attention Layers (from BTC_model)
# ============================================================================

class self_attention_block(nn.Module):
    """Single self-attention block with multi-head attention and feedforward."""
    ...
    def __init__(self, hidden_size, total_key_depth, total_value_depth, filter_size, num_heads,
        ...
        self.multi_head_attention = MultiHeadAttention(hidden_size, total_key_depth, total_value_depth,
                                                       hidden_size, num_heads, bias_mask, attention_dropout, attention_map)
        self.positionwise_convolution = PositionwiseFeedForward(hidden_size, filter_size, hidden_size, 
                                                                layer_config='cc', padding='both', dropout=relu_dropout)
...
class bi_directional_self_attention(nn.Module):
    """Bi-directional self-attention with forward and backward attention."""
...
class bi_directional_self_attention_layers(nn.Module):
    """Stack of bi-directional self-attention layers."""
